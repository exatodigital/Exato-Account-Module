...
{
    public class QueryAccountTypeParameters : AccountModuleParameters
    {
        public QueryAccountTypeParameters(int? accountTypeId, Guid? accountTypeUid, Guid? accountTypeExternalUid, int? accountTypeClientId, string? name, bool? negativeBalanceAllowed, bool? allowedToExpire, DateTime? expireAt, DateTime? createdAt, int? createdBy, DateTime? updatedAt, int? updatedBy, DateTime? deletedAt, int? deletedBy)
        {
