...
namespace ExatoDigital.OpenSource.AccountModule.Repository
{
    public class AccountModuleFacade : IAccountModuleFacade
    {
        ...
        /// <summary>
        /// TODO: Leandro - Considerar se apenas um repositório já bastaria.
        /// TODO: Leandro - Ao invés de passar o repositório, passar uma factory que cria um repositório. Assim você consegue controlar melhor o ciclo de vida das instências (IAccountModuleRepositoryFactory).
        /// TODO: Leandro - Cosmético: eu tiraria os underscore dos nomes dos projetos e namespaces.
        /// </summary>
        ...
        {
            _accountModuleRepositoryFactory = accountModuleRepositoryFactory;
        }

        // public abstract class AccountModuleResult (deu sucesso ou não, mensagens de erro e etc., ou seja, tudo o que for comum para todas as operações.)
        // public class CreateAccountResult : AccountModuleResult (o que for específico da operação, por exemplo o id da conta, UID que foi gerado, etc.)
